        ...
        $.get('/Tuser/info', function (data, error) {
            if (!error) {
                ...
                var addForm = function () {
                    ...
                    var $teacherForm = $formBody.append('<form id="teacher-form" target="_self" action="login/teacherAccountInsert" method="POST">')
                        .children('#teacher-form');
                    $teacherForm.append('<div class="form-li" id="form-li1"><label class="col-lg-2 col-md-2 col-sm-12 control-label">&nbsp&nbsp&nbspID&nbsp&nbsp&nbsp:</label><div class="col-lg-10 col-md-10"><input type="text" name="ID" class="form-control"  autofocus="autofocus"></div></div>')
                        .append('<div class="form-li" id="form-li2"><label class="col-lg-2 col-md-2 col-sm-12 control-label">用&nbsp&nbsp户&nbsp&nbsp名:</label><div class="col-lg-10 col-md-10"><input name="Tuser" type="text" class="form-control" placeholder="填写用户名" autofocus="autofocus"></div></div>')
                        .append('<div class="form-li" id="form-li3"><label class="col-lg-2 col-md-2 col-sm-12 control-label">密&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp码:</label><div class="col-lg-10 col-md-10"><input name="Tpassword" type="text" class="form-control" placeholder="填写密码" autofocus="autofocus"></div></div>')
                        .append('<div class="form-li" id="form-li4"><label class="col-lg-2 col-md-2 col-sm-12 control-label">邮&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp箱:</label><div class="col-lg-10 col-md-10"><input name="Temail" type="text" class="form-control" placeholder="输入需要绑定的邮箱|也可以不绑定" autofocus="autofocus"></div></div>')
                        .append('<div class="form-li" id="form-li5"><label class="col-lg-2 col-md-2 col-sm-12 control-label">电&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp话:</label><div class="col-lg-10 col-md-10"><input name="Ttel" type="text" class="form-control" placeholder="输入电话号码|也可以不输入" autofocus="autofocus"></div></div>')
                ...
                $btnDelete.click(function () {
                    ...
                    alert(tips)
                    var obj = { data: Tnos };
                    $.get('login/teacherAccountDelete', obj);
                    // 删除页面上的数据
                    $clidkedTrs.empty();
                });
                $btnUpdate.click(function () {
                    ...
                    addForm();
                    // 修改表单提交的接口 和方式
                    $('form').attr("action", "login/teacherAccountUpdate");
