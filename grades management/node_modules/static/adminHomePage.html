...
<head>
    ...
    <![endif]-->
        ...
        <link href="assets/css/jquery.ui.all.css" rel="stylesheet" />
        <link href="assets/css/bootstrap.css" rel="stylesheet" />
        <link href="assets/css/plugins.css" rel="stylesheet" />
        <link href="assets/css/main.css" rel="stylesheet" />
        <link href="assets/css/custom.css" rel="stylesheet" />
        <link rel="icon" href="assets/img/ico/favicon.ico" type="image/ico/png">
...
<body>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown">
                                <img class="user-avatar" src="assets/img/avatars/48.jpg" alt="Light">亮</a>
    ...
    <div id="sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul id="sideNav" class="nav nav-pills nav-stacked">
               <li id="nav-teacher"><a href="#">老师基本信息 <i class="ec-user"></i></a>
                </li>
                <li id="nav-student"><a href="#">学生基本信息 <i class="st-users"></i></a>
                </li>
                <li>
                    <a href="#"> 账号&密码<i class="st-support"></i></a>
                    <ul class="nav sub">
                        <li id="nav-Suser"><a href="#"><i class="ec-pencil2"></i> 学生账号</a>
                        </li>
                        <li id="nav-Tuser"><a href="#"><i class="im-checkbox-checked"></i> 老师账号</a>
                        </li>
                    </ul>
                </li>
                <li id="nav-lesson"><a href="#"> 课程信息 <i class="im-table2"></i></a>
                </li>
                <li id="nav-grade"><a href="#"> 学生成绩 <i class="st-files"></i></a>                 
                </li>
                </div>
            </div>
     <!-- End .sidebar-panel -->
    ...
    <div id="content"  style="margin-top: 20px">
        ...
        <script src="assets/js//pages/teacher.js"></script>
        <script src="assets/js//pages/student.js"></script>
        <script src="assets/js//pages/lesson.js"></script>
        <script src="assets/js//pages/grade.js"></script>
        <script src="assets/js//pages/Suser.js"></script>
        <script src="assets/js//pages/Tuser.js"></script>
</body>
</html>
