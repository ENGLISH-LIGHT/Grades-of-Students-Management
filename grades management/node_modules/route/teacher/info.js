...
// 从teacherHomePage 访问的 
router.use('/teacher/getInfo',function(req,res){
    console.log('teacher update info by himself');
    console.log(req.query);
    var q = `SELECT * FROM tb_teacher WHERE Tno = '${req.query.Tno}'`;
    console.log(q);
    db.query(q,(err,data)=>{
        if(err){
            console.error('delete error');
